...
export function Header({ onOpenCopilot: _onOpenCopilot }: HeaderProps) {
  // onOpenCopilot is passed as prop for future use
  return (
        ...
        <div className="flex items-center space-x-8">
          ...
          <div className="relative w-96">
            ...
            <Input 
              ...
              className="pl-10 bg-input-background border focus:ring-2 focus:ring-ring"
            />
          </div>
        </div>
