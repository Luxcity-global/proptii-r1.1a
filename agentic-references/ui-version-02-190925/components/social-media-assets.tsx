...
import { EnhancedLayerPanel } from "./layer/EnhancedLayerPanel";
import { Layer } from "../types/layerManagement";
...
export function SocialMediaAssets({ onBack }: SocialMediaAssetsProps) {
  ...
  const [expandedTray, setExpandedTray] = useState<string | null>("templates");

  // Enhanced layer management with new Layer interface
  ...
  const handleGenerateWithAI = async () => {
    ...
    console.log("AI asset generated successfully! Multiple variations created.");
  };
  ...
  const handleExportAsset = () => {
    console.log("Asset exported successfully");
  };
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-[1600px] mx-auto">
        <div className="flex h-[calc(100vh-160px)]">
          ...
          <div className="social-builder-tool-sidebar">
                ...
                {toolTrays.map((tray) => {
                  ...
                  return (
                    <button
                      ...
                      className={`social-builder-tool-button ${isSelected ? 'active' : ''}`}
                      title={tray.name}
                    >
                      <Icon className="social-builder-tool-icon" />
                      <span className="social-builder-tool-label">
                        {tray.name}
                      </span>
                    </button>
                  );
          ...
          {expandedTray && (
            <div className="social-builder-tool-panel">
              <div className="social-builder-tool-panel-header">
                <h3 className="social-builder-tool-panel-title">
              ...
              <ScrollArea className="flex-1">
                <div className="social-builder-tool-panel-content">
                  {/* Templates Content */}
                  {expandedTray === 'templates' && (
                    <div className="space-y-4">
                      <div className="social-builder-template-grid">
                        {templates.map((template) => (
                          <div
                            key={template.id}
                            className={`social-builder-template-card ${
                              selectedTemplate.id === template.id ? 'active' : ''
                            }`}
                            onClick={() => setSelectedTemplate(template)}
                          >
                            <div className="social-builder-template-preview">
                              <ImageWithFallback
                            ...
                            <div className="social-builder-template-info">
                              <h5 className="social-builder-template-name">{template.name}</h5>
                              <p className="social-builder-template-description">{template.description}</p>
                            </div>
                          </div>
                        ))}
                      </div>
              ...
              <div className="social-builder-caption-editor">
                <Label className="social-builder-caption-label">Caption</Label>
                <Textarea
                  placeholder="Write your caption here..."
                  value={caption}
                  onChange={(e) => setCaption(e.target.value)}
                  className="social-builder-caption-textarea"
                />
                <div className="social-builder-caption-footer">
                  <span className="social-builder-caption-counter">{caption.length}/2200</span>
                  <Button variant="ghost" size="sm" className="social-builder-hashtag-button">
