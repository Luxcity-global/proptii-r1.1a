...
interface WelcomePageProps {
  ...
  onNavigateToWriteContent: () => void;
  onNavigateToSocialAssets: () => void;
  onOpenCopilot: () => void;
...
export function WelcomePage({ 
  ...
  onNavigateToWriteContent,
  onNavigateToSocialAssets,
  onOpenCopilot,
  ...
  const actionCards = [
    {
      ...
      color: "lux-orange",
      action: onNavigateToSocialAssets,
      visual: (
    ...
    },
    {
      ...
      variant: "outline" as const,
      color: "lux-orange",
      action: onNavigateToWriteContent,
      visual: (
        <div className="relative w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-lux-orange-50 to-lux-orange-100 rounded-2xl flex items-center justify-center">
          ...
          <div className="text-center space-y-8">
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl text-[rgba(19,108,158,1)] max-w-3xl mx-auto leading-relaxed">
                Generate compelling content, launch targeted campaigns, and attract quality tenants faster than ever
              </p>
            </div>
            ...
            <div className="flex justify-center">
              <Button 
                size="lg" 
                className="bg-lux-blue-600 hover:bg-lux-blue-700 focus:ring-2 focus:ring-lux-blue-400 text-lg px-8 py-4 h-auto rounded-[36px]"
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl">
                {actionCards.map((card) => {
                  ...
                  return (
                    <Card
                      key={card.id}
                      className={`group cursor-pointer transition-all duration-500 ease-out rounded-3xl border-8 border-white bg-lux-cream-100 shadow-sm hover:shadow-xl w-80 h-80 ${
                        isHovered 
