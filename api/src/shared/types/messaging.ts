/**
 * Cosmos DB messaging TypeScript interfaces for the Proptii Communication Feature.
 *
 * Each interface maps to a Cosmos DB container. JSDoc comments indicate the
 * container name and partition key for each entity.
 */
...
// ---------------------------------------------------------------------------
// DTO types used by services and controllers
// ---------------------------------------------------------------------------
...
/**
 * The role of the message sender within a conversation.
 */
export type SenderRole = 'tenant' | 'landlord';
