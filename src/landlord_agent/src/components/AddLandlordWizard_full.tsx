...
export function AddLandlordWizard({ onBack, onSaved }: AddLandlordWizardProps) {
  ...
  const validateStep = (stepId: string) => {
    ...
    switch (stepId) {
      ...
      case 'leaseStart':
      case 'leaseEnd':
        return !!state.formData[stepId as keyof LandlordFormData] && isTodayOrFuture(state.formData[stepId as keyof LandlordFormData] as string);
      case 'emergencyName':
...
export const FormTestUtils = {
  ...
  isStepValid: (stepId: string, formData: LandlordFormData): boolean => {
    switch (stepId) {
      ...
      case 'leaseStart':
      case 'leaseEnd':
        return !!formData[stepId as keyof LandlordFormData] && new Date(formData[stepId as keyof LandlordFormData] as string) >= new Date();
      case 'emergencyName':
