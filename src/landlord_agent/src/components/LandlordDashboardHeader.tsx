...
import LandlordPlanBadgePopover from './LandlordPlanBadgePopover';
            ...
            <div
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.boxShadow =
                  '0 8px 20px rgba(255, 248, 220, 0.6), 0 4px 10px rgba(0, 0, 0, 0.1)';
                e.currentTarget.style.transform = 'translateY(-1px)';
                e.currentTarget.style.background =
                  'linear-gradient(135deg, #F3FFDD 0%, #EEFFFF 100%)';
              }}
              onMouseLeave={(e) => {
            ...
            >
              <div className="flex items-center space-x-3">
                <div className="text-left">
                  <p className="text-sm leading-tight font-medium" style={{ color: '#374957' }}>
                    PropWise
                  </p>
                  <p className="text-xs leading-tight" style={{ color: '#717182' }}>
                    AI Powered
                  </p>
                </div>
                <div
