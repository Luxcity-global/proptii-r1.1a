...
export function AmenitiesSelection({ selectedAmenities: propSelectedAmenities, onAmenitiesChange, onNext, onBack, onHome, onPropertySetup, onSaveAndExit }: AmenitiesSelectionProps) {
