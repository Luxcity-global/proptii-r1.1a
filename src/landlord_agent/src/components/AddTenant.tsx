              ...
              <div className="space-y-3">
                <div className="relative group">
                  ...
                  {state.formData.annualIncome && !state.errors.annualIncome && validateStep('income') && (
                    <CheckCircle className="absolute right-6 top-1/2 -translate-y-1/2 w-5 h-5 text-green-500 animate-bounce z-10 pointer-events-none" style={{ right: '24px' }} />
                  )}
                  {state.errors.annualIncome && (
                    <div className="absolute right-6 top-1/2 -translate-y-1/2 z-10 pointer-events-none" style={{ right: '24px' }}>
                      <AlertTriangle className="w-5 h-5 text-red-500 animate-shake" />
                    </div>
                  )}
                </div>
