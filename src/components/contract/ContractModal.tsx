...
const ContractModal: React.FC<ContractModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
      {/* Sidebar 
      <div
        className={`fixed left-0 top-0 h-full bg-white shadow-md w-74 p-4 transform ${
      ...
      >
        ...
        <div className="flex flex-col items-center p-6 w-64 bg-white text-gray-900">
    <h2 className="text-xl font-bold text-orange-600 text-left mb-8">Actions Menu</h2>
    ...
    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-orange-500 bi bi-upload"  width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
    ...
    <button className="flex items-center gap-2 text-gray-600 mt-6 hover:text-gray-900">
        <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 text-orange-500 bi bi-person" width="16" height="16" fill="currentColor">
      ...
      <div className="bg-[#EDF3FA] max-h-[700px] rounded-md shadow-lg w-full max-w-3xl p-6 relative pt-20">
        ...
        {/* Sidebar Overlay */}
  {isSidebarOpen && (
    <div className="absolute inset-0 bg-black bg-opacity-30 z-20 flex">
