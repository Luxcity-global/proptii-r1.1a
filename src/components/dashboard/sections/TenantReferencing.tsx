...
// Helper function to create dynamic sections based on referencing data
const createDynamicSections = (referencingData: any): Section[] => {
  if (!referencingData) {
    return [];
  }

  const getStatus = (isCompleted: boolean) => isCompleted ? "Complete" : "Not Started";
  const getCheckStatus = (isCompleted: boolean) => isCompleted ? "complete" : "notStarted";

  return [
    {
      title: "Identity",
      date: formatDate(new Date().toISOString()),
      status: getStatus(referencingData.identity),
      checks: [
        { name: "Name", status: getCheckStatus(referencingData.identity) },
        { name: "Contact", status: getCheckStatus(referencingData.identity) },
        { name: "Nationality", status: getCheckStatus(referencingData.identity) },
      ],
      icon: <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_1719_10279)">
      ...
      title: "Employment",
      date: formatDate(new Date().toISOString()),
      status: getStatus(referencingData.employment),
      checks: [
        { name: "Employment Status", status: getCheckStatus(referencingData.employment) },
        { name: "Job Position", status: getCheckStatus(referencingData.employment) },
        { name: "Job Reference", status: getCheckStatus(referencingData.employment) },
        { name: "Company Details", status: getCheckStatus(referencingData.employment) },
      ],
      icon: <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_1724_13794)">
      ...
      title: "Residential",
      date: formatDate(new Date().toISOString()),
      status: getStatus(referencingData.residential),
      checks: [
        { name: "Address", status: getCheckStatus(referencingData.residential) },
        { name: "Duration", status: getCheckStatus(referencingData.residential) },
      ],
      icon: <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_1724_13838)">
      ...
      title: "Financial",
      date: formatDate(new Date().toISOString()),
      status: getStatus(referencingData.financial),
      checks: [
        { name: "Proof of Income", status: getCheckStatus(referencingData.financial) },
        { name: "Monthly Income", status: getCheckStatus(referencingData.financial) }
      ],
      icon: <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_1726_13876)">
      ...
      title: "Guarantor",
      date: formatDate(new Date().toISOString()),
      status: getStatus(referencingData.guarantor),
      checks: [
        { name: "Address", status: getCheckStatus(referencingData.guarantor) },
        { name: "Name", status: getCheckStatus(referencingData.guarantor) },
        { name: "Contact", status: getCheckStatus(referencingData.guarantor) }
      ],
      icon: <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g clipPath="url(#clip0_1726_13921)">
      ...
      title: "Agent Details",
      date: formatDate(new Date().toISOString()),
      status: getStatus(referencingData.agentDetails),
      checks: [
        { name: "Personal Details", status: getCheckStatus(referencingData.agentDetails) }
      ],
      icon: <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const TenantReferencing: React.FC = () => {
  ...
  // Create dynamic sections based on referencing data
  const sections = createDynamicSections(dashboardSummary?.referencing);
