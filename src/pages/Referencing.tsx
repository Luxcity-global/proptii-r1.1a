...
/** Decorative dot grid (no separate magic-ui module in repo) */
const DotPattern: React.FC<{ className?: string }> = ({ className = '' }) => (
  <div
    ...
    aria-hidden
    style={{
      backgroundImage: 'radial-gradient(circle, rgba(19, 108, 158, 0.12) 1px, transparent 1px)',
      ...
      <section className="h-[80vh] relative flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 text-center w-full">
          ...
          <button
            ...
            className="bg-transparent text-[#DC5F12] px-10 py-4 rounded-full hover:bg-[#DC5F12] hover:text-white text-xl font-medium border-2 transition-colors"
            style={{
              borderColor: '#DC5F12',
            }}
          >
        ...
        <div className="relative container mx-auto flex flex-col md:flex-row items-start gap-8 md:gap-12 w-full overflow-hidden" style={{ backgroundColor: 'rgba(247, 247, 247, 0.5)', minHeight: '500px', padding: '2rem', paddingLeft: '4rem', maxWidth: '90%', borderRadius: '1.5rem', backdropFilter: 'blur(10px)' }}>
          ...
          <div className="w-full md:w-2/5 space-y-6 md:space-y-10 text-center md:text-left md:absolute md:top-1/2 md:-translate-y-1/2 md:left-48 md:rounded-lg md:p-6 relative z-50">
            ...
            <button
              type="button"
              onClick={handleGetStarted}
              className="bg-transparent text-[#DC5F12] font-medium px-6 py-3 rounded-full hover:bg-[#DC5F12] hover:text-white shadow-md hover:shadow-lg border-2 transition-colors"
              style={{
                borderColor: '#DC5F12',
              }}
            >
