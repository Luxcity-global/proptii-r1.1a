  ...
  return (
    <section>
      ...
      <p className="text-sm md:text-base text-[#374957] mb-6 max-w-2xl">
        These rules protect Scout from drifting off-model or being used in ways that dilute the brand. When in doubt,
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        <div className="rounded-2xl bg-white border border-gray-100 shadow-sm p-5">
          ...
          <ul className="text-sm text-[#374957] space-y-2">
            <li>· Keep compositions simple and focused on Scout.</li>
            <li>· Use approved poses and expressions aligned with this page.</li>
            <li>· Ask the brand team if a new context or treatment isn&apos;t covered here.</li>
          </ul>
        </div>
        ...
        <div className="rounded-2xl bg-[#FFF4F4] border border-[#F97373] shadow-sm p-5">
          ...
          <ul className="text-sm text-[#7F1D1D] space-y-2">
            <li>· Don&apos;t use complex scene compositions or over-detailed illustrations.</li>
            <li>· Don&apos;t create pins or small metal items that include the full body – face-only only.</li>
            <li>· Don&apos;t use Scout in website loading animations or spinners.</li>
            <li>· Don&apos;t remix Scout with off-brand props, costumes, or meme formats.</li>
          </ul>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
        ...
        <div className="rounded-2xl bg-white border border-gray-100 shadow-sm p-4">
          ...
          <div className="grid grid-cols-2 gap-2 text-[11px] text-[#374957]">
            ...
            <div className="border border-dashed border-[#22C55E] rounded-lg h-20 flex items-center justify-center text-center px-2">
              Scout in completion state, after the task is done.
            </div>
          </div>
        </div>
      </div>
