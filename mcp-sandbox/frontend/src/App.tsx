...
import { MapIntegrationSection } from './components/MapIntegration';
    ...
    >
      ...
      {!searchPerformed ? (
        ...
        <>
          ...
          {/* Map Integration Section - Always show when search is performed */}
          {searchPerformed && !loading && !error && (
            <div style={{ width: '100%', maxWidth: 1200, margin: '32px auto 0 auto', padding: '0 16px' }}>
              <MapIntegrationSection
                ...
                searchLocation={{
                  lat: getLocationCoordinates(searchQuery).lat,
                  lng: getLocationCoordinates(searchQuery).lng,
                  address: searchQuery
                }}
                radiusKm={5}
                isLoading={loading}
