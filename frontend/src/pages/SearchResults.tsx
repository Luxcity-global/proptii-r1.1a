          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="mb-6">
                ...
                <div className="text-3xl font-bold" style={{ color: '#E65D24' }}>{property.price.replace(/Tenancy info£/, 'Tenancy info £')}</div>
              </div>
            ...
            <>
              ...
              <div className="absolute top-4 left-4 space-y-2">
                <div className="bg-green-500 text-white text-xs font-semibold px-3 py-1 rounded-full shadow-lg">
                  {property.price.includes('rent') || property.price.includes('pcm') ? 'To Rent' : 'For Sale'}
                </div>
          ...
          <div className="flex items-start justify-between mb-4">
            <div className="flex-1">
              ...
              <div className="text-2xl font-semibold mb-2" style={{ color: '#E65D24' }}>
                {property.price.replace(/Tenancy info£/, 'Tenancy info £')}
              </div>
            </div>
          </div>
